        ...
        reviceListFn(){
            ...
            if(this.multipleSelection.length>1){
                ...
                this.dialogForm.addFieldForm={
                    ...
                    group: this.multipleSelection[0].group,
                    langTexts:this.multipleSelection[0].langTexts,
                    lang:2,
                    text:'',
                }
            ...
            if(this.multipleSelection.length==0){
                 ...
                 this.$confirm(that.$t("message.SureToDelet"), that.$t("message.Title"), {
                    ...
                    for (var i = data.length - 1; i >= 0; i--) {
                        reques.push(
                            that.postAjax("/Lang/Delete",{"id":that.multipleSelection[i].id},function(res){},function(res){})
                        );
                    }
