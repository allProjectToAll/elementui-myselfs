...
export default {
    ...
    methods:{
        ...
        getImg(id){
            return this.$store.state.url+"/Image/"+(this.multipleSelection[0]?this.multipleSelection[0].userId:"no")+"/"+id;
        },
        getBtn(){
            let that = this;
        ...
        deTailMessage(){//详细信息
            ...
            if(this.multipleSelection.length>1){
                ...
                if(this.multipleSelection[0].status == "2"||this.multipleSelection[0].status == "3"){
                ...
                let par = {
                 ...
                 this.postAjax("/Certification/Detail",par,function(res){
                     console.log(res);
                     that.fullscreenLoading = false;
                     that.dialog.addDialogSync = true;
