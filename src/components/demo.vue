<template>
  <div class="demo">
    ...
    <div class="clear"></div>
    <!-- /***************************************************************************/ -->
    <div class="titleName">详情</div>
    <el-button type="primary" @click="toDetail">详情</el-button>
    <basic-detail :detailInFo="detailInFo" @on-cancel="detailInFo.dialogAsync == false" @update="updatedetailInFo"></basic-detail>
    <br/>
...
export default {
    ...
    data() {
      return {
        ...
        detailInFo:{
          cols:12,//8为三列，12为两列，24为一列
          labelWidth:12,//共24份，前面名称和后面数据的比例 num就是num:(24-num);
          dialogAsync:false,//弹框显示
          items:{
            name:"名称",
            age:"年龄",
